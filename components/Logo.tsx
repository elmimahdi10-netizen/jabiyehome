    ...
    <header className="sticky top-0 z-50 bg-white border-b border-border/50">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4">
        ...
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: "12px", textDecoration: "none" }}>
          <svg viewBox="0 0 60 74" xmlns="http://www.w3.org/2000/svg" style={{ height: "44px", width: "36px" }}>
          ...
          <div style={{ lineHeight: 1 }}>
            <div style={{ fontSize: "20px", fontWeight: "800", color: "#111827", letterSpacing: "-0.5px" }}>JABIYE</div>
            <div style={{ fontSize: "12px", fontWeight: "600", color: "#16A34A", letterSpacing: "4px", marginTop: "2px" }}>HOME</div>
          </div>
        </Link>
        {/* NAV */}
...
'''
open('components/layout/Header.tsx', 'w').write(content)
print('Done')
PYEOF